...
def make_periodic_table():
    """
    A dictionary of all the elements of the periodic table in this format:
    periodic_table_dict = Symbol: [Name, Atomic Mass]
    """
    periodic_table_dict = {
    "Ac": ["Actinium", 227],
    "Ag": ["Silver", 107.8682],
...
def make_known_molecules_dict():
    """
    A dictionary of known chemical formulas and their names:
    known_molecules_dict = Formula: Name
    """
...
def main():
    ...
    new_formula = parse_formula(formula, periodic_table)

    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    molar_mass = compute_molar_mass(new_formula, periodic_table)

    # Compute the number of moles in the sample.
    moles = mass / molar_mass

    # Find known chemical formula name if applicable.
...
#         print(f"{element_name} - {element_atomic_mass}")
#     compute_molar_mass()